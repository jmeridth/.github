...
Please note we have a [code of conduct](https://github.com/jmeridth/.github/blob/main/.github/CODE_OF_CONDUCT.md); please follow it in all your interactions with the project.
